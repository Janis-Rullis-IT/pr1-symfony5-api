...
class CountryValidator
{
    ...
    public function validateAlphabetic(string $country): bool
    {
        foreach ($this->countryListAllIsoData as $countryData) {
            if (strtolower($country) === strtolower($countryData['code'])
                || strtolower($country === $countryData['code3'])
                || strtolower($country === $countryData['name'])) {
                return true;
            }
        }
    ...
    public function validateNumeric(string $country): bool
    {
        foreach ($this->countryListAllIsoData as $countryData) {
            if ($country === $countryData['number']) {
                return true;
            }
        }
